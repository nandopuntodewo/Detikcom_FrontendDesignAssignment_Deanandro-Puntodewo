    ...
    <section id="berita">
      <section className="sec4">
        ...
        <div className="artikel">
          ...
          <div className="teks-artikel-all">
            <h4>
              [Artikel] Kelar Lari di CT Arsa Charity Fun Run, 'Recharge' Energi
              Nonton Maliq &amp; D'essentials
            </h4>
            <h4> [Artikel] CT Arsa Charity Fun Run 2023 Bertabur Emas</h4>
            <h4>
              {" "}
              [Artikel] BTN Jakarta Run 2023 Dorong dan Geliatkan Sport Tourism
              Jakarta
            </h4>
          </div>
          <div>
        ...
        <div className="foto">
          ...
          <div className="teks-artikel-all">
            ...
            <h4 className="teks-artikel1">
              {" "}
              [Foto] Edukasi Lingkungan Hidup Bonus Sehat di 'Misi Lestari 2023:
              See Nature
            </h4>
            <h4>
              [Foto] Sukses Finish Marathon di Jakarta, Osha Penyandang Autisme
              Beberkan Prosesnya
            </h4>
          </div>
          <div className="date-artikel-all">
        ...
        <div className="video">
          ...
          <div className="teks-artikel-all">
            <h4 className="teks-artikel">
              [Video] Sukses Finish Marathon di Jakarta, Osha PenyandangAutisme
              Beberkan Prosesnya
            </h4>
            <h4 className="teks-artikel1">
            ...
            <h4>
              {" "}
              [Video] Sukses Finish Marathon di Jakarta, Osha Penyandang Autisme
              Beberkan Prosesnya
            </h4>
          </div>
          <div className="date-artikel-all">
